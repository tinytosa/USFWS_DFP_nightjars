...
cwwi2 <- cwwi2[cwwi2$state != "CT",] #need to remove CT routes from CWWI since not surveyed
nrow(cwwi2)
cwwi2$species <- "CWWI"
...
nrow(coni2)
coni2$species <- "CONI"
coni2 <- coni2[coni2$state != "CT",] #need to remove CT sites since CT only surveyed for EWPW
