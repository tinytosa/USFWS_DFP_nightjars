...
ggsave(c.plot, filename="../Figures/occupancy/stacked_occupancy_det_coefficients_CWWI.tiff")
...
plot.marginal <- function(par, par.name, type)
{
  ...
  print(o)
  ggsave(o, filename=paste("../Figures/occupancy/stacked_occupancy_",type,"_CWWI_", par,".tiff", sep=""), height=6, width=6, unit="in", dpi=300, compression="lzw")
}
...
ggsave(filename = "../Figures/occupancy/stacked_occupancy_psi_state-bcr-year_CWWI.tiff", height=30, width=16, units="in", dpi=400, compression="lzw")

p + facet_wrap(~state, ncol=2, dir="v")
ggsave(filename = "../Figures/occupancy/stacked_occupancy_psi_state-bcr-year2_CWWI.tiff", height=20, width=20, units="in", dpi=400, compression="lzw")
...
ggplot(m.data, aes(x=state, y=Predicted)) +
  ...
  xlab("state") + ylab(paste("Predicted probability of occupancy")) + ylim(c(0,1)) +
  theme_bw(base_size=20) + theme(panel.grid=element_blank())
ggsave(filename="../Figures/occupancy/stacked_occ_psi_state_CWWI.tiff", height=6, width=8, units="in", dpi=400, compression="lzw")
...
ggplot(m.data, aes(x=BCR, y=Predicted)) +
  ...
  theme_bw(base_size=20) + theme(panel.grid=element_blank())
ggsave(filename="../Figures/occupancy/stacked_occ_psi_BCR_CWWI.tiff", height=6, width=8, units="in", dpi=400, compression="lzw")
